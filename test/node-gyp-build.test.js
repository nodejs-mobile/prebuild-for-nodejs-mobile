...
tape('node-gyp-build native module for android-arm(v7)', async (t) => {
  const prebuild4 = path.join(__dirname, '..', 'bin.js');
  const project = path.join(__dirname, 'bufferutil');
  ...
  const pathToOutput = path.join('prebuilds', target, 'bufferutil.node');
...
tape('node-gyp-build native module for android-arm64(v8)', async (t) => {
  const prebuild4 = path.join(__dirname, '..', 'bin.js');
  const project = path.join(__dirname, 'bufferutil');
...
tape('node-gyp-build native module for android-x64', async (t) => {
  const prebuild4 = path.join(__dirname, '..', 'bin.js');
  const project = path.join(__dirname, 'bufferutil');
